        ...
        <div className='elements'>
          ...
          <Row>
            <Item src='/img/categories/lift-1.png'>
              <LinkWrapper to='/'>
                <Title>Пассажирские<br/>лифты</Title>
              </LinkWrapper>
            </Item>
            <Item src='/img/categories/lift-2.png'>
              <LinkWrapper to='/'>
                <Title>Грузовые<br/>лифты</Title>
              </LinkWrapper>
            </Item>
            <Item row>
              <Item src='/img/categories/lift-3.png'>
                <LinkWrapper to='/'>
                  <Title>Коттеджные<br/>лифты</Title>
                </LinkWrapper>
              </Item>
              <Item src='/img/categories/lift-4.png'>
                <LinkWrapper to='/'>
                  <Title>Малые<br/>грузовые</Title>
                </LinkWrapper>
              </Item>
            </Item>
          </Row>
          <Row>
            <Item row>
              <Item src='/img/categories/lift-5.png'>
                <LinkWrapper to='/'>
                  <Title>Панорамные<br/>лифты</Title>
                </LinkWrapper>
              </Item>
              <Item src='/img/categories/lift-6.png'>
                <LinkWrapper to='/'>
                  <Title>Больничные<br/>лифты</Title>
                </LinkWrapper>
              </Item>
            </Item>
          ...
          <Row>
            <Item src='/img/categories/lift-9.png'>
              <LinkWrapper to='/'>
                <Title>Грузовые<br />подъемники</Title>
              </LinkWrapper>
            </Item>
            <Item src='/img/categories/lift-10.png'>
              <LinkWrapper to='/'>
                <Title>Комплектующие<br />для лифтов</Title>
              </LinkWrapper>
            </Item>
            <Item row>
              <Item src='/img/categories/lift-11.png'>
                <LinkWrapper to='/'>
                  <Title>Конструкции<br />лифтов</Title>
                </LinkWrapper>
              </Item>
              <Item src='/img/categories/lift-12.png'>
                <LinkWrapper to='/'>
                  <Title>Собственное<br />производство</Title>
                </LinkWrapper>
              </Item>
            </Item>
          </Row>
